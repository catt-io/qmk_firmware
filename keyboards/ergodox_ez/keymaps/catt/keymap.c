...
[SYMB] = LAYOUT_ergodox(
        ...
        _______, KC_DLR,  KC_HASH, KC_AT,   KC_TAB,  KC_TILD, _______,
        ...
        KC_LEFT, _______, KC_PIPE, KC_PERC, KC_CIRC, KC_GRAVE, _______,
                 KC_EXLM, KC_PLUS, KC_ASTR, KC_EQL,  KC_UNDS, _______,
        KC_RIGHT,KC_AMPR, KC_MINS, KC_SLSH, KC_BSLS, _______, _______,
