...
[SYMB] = LAYOUT_ortho_4x12( \
  _______,         KC_DLR,  KC_HASH, KC_AT,   KC_TAB,  KC_TILD, SS_SPOT, KC_PIPE, KC_PERC, KC_CIRC, KC_GRAVE, _______, \
  _______,         KC_LABK, KC_LBRC, KC_LCBR, KC_LPRN, KC_QUES, KC_EXLM, KC_PLUS, KC_ASTR, KC_EQL,  KC_UNDS, _______, \
  _______,         KC_RABK, KC_RBRC, KC_RCBR, KC_RPRN, CK_RARW, KC_AMPR, KC_MINS, KC_SLSH, KC_BSLS, KC_COLN, _______, \
  _______,         _______, _______, KC_LEFT, KC_UP,   KC_ESC,  KC_ENT,  KC_DOWN, _______, _______, _______, _______ \
),

[NUMP] = LAYOUT_ortho_4x12( \
  _______,         KC_F10,  KC_F1,   KC_F2,   KC_F3,   TG(WIND),_______, KC_1,    KC_2,    KC_3,    _______, _______, \
  _______,         KC_F11,  KC_F4,   KC_F5,   KC_F6,   _______, KC_DOT,  KC_4,    KC_5,    KC_6,    KC_0,    _______, \
  _______,         KC_F12,  KC_F7,   KC_F8,   KC_F9,   _______, _______, KC_7,    KC_8,    KC_9,    _______, _______, \
  RESET,           _______, _______, _______, KC_LEFT, _______, KC_DEL,  KC_RIGHT, _______, _______, _______, RESET \
),
